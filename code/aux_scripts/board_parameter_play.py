...
# Load the image
image_path = "imagini_auxiliare/03.jpg"
...
cv2.createTrackbar('Lower threshold', "Grayscale Adjustments", 125, 255, nothing)
...
while True:
    ...
    edge_image = cv2.Canny(thresh, param_1, param_2)
